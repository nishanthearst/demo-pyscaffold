...
Welcome to `demo-pyscaffold` contributor's guide.
...
If you experience bugs or general issues with `demo-pyscaffold`, please have a look
...
You can help improve `demo-pyscaffold` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`demo-pyscaffold` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `demo-pyscaffold`'s files. While this mechanism can
...
```
conda create -n demo-pyscaffold python=3 six virtualenv pytest pytest-cov
conda activate demo-pyscaffold
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/demo-pyscaffold.git
   cd demo-pyscaffold
   ```
...
5. Install [pre-commit]:
   ...
   `demo-pyscaffold` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/demo-pyscaffold
[issue tracker]: https://github.com/<USERNAME>/demo-pyscaffold/issues
